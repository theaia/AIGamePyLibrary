...
# Matches `TennisGet*Gate.LabelAliases`.
DROPDOWN_ALIASES: dict[str, dict[str, str]] = {
    "TennisGetBool": {
        "i am serving": "Is Self Server",
        "is server": "Is Self Server",
        "self is server": "Is Self Server",
        "opponent is server": "Is Opponent Server",
        "is any team serving": "Is Serve Phase",
        "is serving": "Is Self Serving",
        "self is serving": "Is Self Serving",
        "ball on my side": "Ball On Self Side",
        "can hit": "Is Ball Playable",
        "can swing": "Is Ball Playable",
        "ball is playable": "Is Ball Playable",
        "ball is lob": "Is Ball Lob",
        "ball is drop": "Is Ball Drop",
    ...
    "TennisGetFloat": {
        ...
        "est time ball to ground": "Time Ball To Ground",
        "est time to destination": "Time To Destination",
